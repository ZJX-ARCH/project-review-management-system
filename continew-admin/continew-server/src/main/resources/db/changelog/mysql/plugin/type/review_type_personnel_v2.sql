...
-- preconditions onFail:MARK_RAN
-- precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS WHERE TABLE_NAME='review_type_personnel_config' AND INDEX_NAME='idx_node_type' AND TABLE_SCHEMA=DATABASE()
ALTER TABLE `review_type_personnel_config`
